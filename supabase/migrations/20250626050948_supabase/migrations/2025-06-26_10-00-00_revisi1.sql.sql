create type "public"."Asal_Pengunjung" as enum ('BMKG', 'Dinas', 'Universitas', 'Media', 'Lembaga Non Pemerintahan', 'Umum');

create type "public"."Peran_Admin" as enum ('Admin', 'Superadmin');

create type "public"."status_kunjungan_enum" as enum ('menunggu persetujuan', 'disetujui', 'dibatalkan');
...
create table "public"."Alamat_Detail" (
    "ID_Alamat_Detail" uuid not null default gen_random_uuid(),
...
CREATE UNIQUE INDEX "Alamat_Detail_pkey" ON public."Alamat_Detail" USING btree ("ID_Alamat_Detail");
...
alter table "public"."Alamat_Detail" add constraint "Alamat_Detail_pkey" PRIMARY KEY using index "Alamat_Detail_pkey";
...
alter table "public"."Alamat_Detail" add constraint "fk_alamat" FOREIGN KEY ("ID_Alamat") REFERENCES "Alamat"("ID_Alamat") ON DELETE CASCADE not valid;

alter table "public"."Alamat_Detail" validate constraint "fk_alamat";
...
grant delete on table "public"."Alamat_Detail" to "anon";

grant insert on table "public"."Alamat_Detail" to "anon";

grant references on table "public"."Alamat_Detail" to "anon";

grant select on table "public"."Alamat_Detail" to "anon";

grant trigger on table "public"."Alamat_Detail" to "anon";

grant truncate on table "public"."Alamat_Detail" to "anon";

grant update on table "public"."Alamat_Detail" to "anon";

grant delete on table "public"."Alamat_Detail" to "authenticated";

grant insert on table "public"."Alamat_Detail" to "authenticated";

grant references on table "public"."Alamat_Detail" to "authenticated";

grant select on table "public"."Alamat_Detail" to "authenticated";

grant trigger on table "public"."Alamat_Detail" to "authenticated";

grant truncate on table "public"."Alamat_Detail" to "authenticated";

grant update on table "public"."Alamat_Detail" to "authenticated";

grant delete on table "public"."Alamat_Detail" to "service_role";

grant insert on table "public"."Alamat_Detail" to "service_role";

grant references on table "public"."Alamat_Detail" to "service_role";

grant select on table "public"."Alamat_Detail" to "service_role";

grant trigger on table "public"."Alamat_Detail" to "service_role";

grant truncate on table "public"."Alamat_Detail" to "service_role";

grant update on table "public"."Alamat_Detail" to "service_role";
